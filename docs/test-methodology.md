...
> 编号 1–10 来自 pi-agents-helper 演化期与本项目早期；11–14 为 2026-09-10
> e2e10（多视角评审自身实现）产出——那轮暴露的一类问题是"**制品文本**的
> 断言失真与口径缺失"（规格/文档/日志层），与 1–10 的"运行/装置层"互补。
